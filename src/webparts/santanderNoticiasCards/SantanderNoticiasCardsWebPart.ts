...
export default class SantanderNoticiasCardsWebPart extends BaseClientSideWebPart <ISantanderNoticiasCardsWebPartProps> {

  public render(): void {
    this.domElement.innerHTML = `
      <div class="${ styles.santanderNoticiasCards }">
